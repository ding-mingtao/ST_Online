              ...
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="password" id="password1"  lay-verify="password1|required"   placeholder="密码" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="password2" id="password2"  lay-verify="password2|required"   placeholder="重复密码" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'form', 'http', 'jquery'], function() {
      ...
      form.on('submit(register)', function(data) {
          /* 向后端发送一个POST请求，请求的URL是tablename + '/register'，
          其中data.field包含了表单中的所有字段数据（如用户名、密码、姓名等）。
          后端服务接收到这个请求后，会处理这些数据并将它们存储到数据库中。*/
