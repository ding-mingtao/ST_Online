                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="idNumber" id="idNumber" placeholder="身份证号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#idNumber').val() != null && jquery('#idNumber').val() != "" && jquery('#idNumber').val() != "null" ) {
                param['idNumber'] = jquery('#idNumber').val();
            }
     
            if (jquery('#phone').val() != null && jquery('#phone').val() != "" && jquery('#phone').val() != "null" ) {
                param['phone'] = jquery('#phone').val();
            }
                    // 获取列表数据
