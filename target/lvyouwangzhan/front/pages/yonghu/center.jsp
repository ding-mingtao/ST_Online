	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="line-container">
				<h2 class="line" style="background: #EEEEEE;"> 个人中心 </h2>
			</div>
			<!-- 标题 -->
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="idNumber" id="idNumber"  lay-verify="required|identity"   placeholder="身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="phone" id="phone"  lay-verify="required|phone"   placeholder="手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
