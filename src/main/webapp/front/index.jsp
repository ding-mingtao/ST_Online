        ...
        <div class="am-headerv">
            <div class="am-pc-nav am-ipad-hide" aos="fade-left" style="z-index: 1000;">
                <ul>
                    ...
                    <li class=''>
                        <a href="javascript:navPage('./pages/jingdian/list.jsp');" class="am-pclink">景点</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
                    <li class=''>
                        <a href="javascript:navPage('./pages/jiudian/list.jsp');" class="am-pclink">酒店</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
                    <li class=''>
                        <a href="javascript:navPage('./pages/luxian/list.jsp');"class="am-pclink">路线</a>
                        <span class="am-pclink-borv"><span></span></span>
                    </li>
                    <li class=''>
